...
- (void)testTimeInGame
{
    ...
    NSInteger lastCount = [[PHTimeInGame getInstance] getCountSessions];
    ...
    NSInteger sessionCount = [[PHTimeInGame getInstance] getCountSessions];
    ...
    NSInteger firstCount = [[PHTimeInGame getInstance] getCountSessions];
