...
@interface NSString_QueryComponentsTest : SenTestCase
@end
...
{
    STAssertEqualObjects(kPHDecodedTestString1, [kPHTestString1 stringByEncodingURLFormat], @"The "
                "decoded string doesn't match the expected one!");
    STAssertEqualObjects(kPHTestString1, [[kPHTestString1 stringByEncodingURLFormat]
                stringByDecodingURLFormat], @"The decoded string should be equal to the original "
                "string!");

    STAssertEqualObjects(kPHDecodedTestString2, [kPHTestString2 stringByEncodingURLFormat], @"The "
                "decoded string doesn't match the expected one!");
    STAssertEqualObjects(kPHTestString2, [[kPHTestString2 stringByEncodingURLFormat]
                stringByDecodingURLFormat], @"The decoded string should be equal to the original "
                "string!");
}
