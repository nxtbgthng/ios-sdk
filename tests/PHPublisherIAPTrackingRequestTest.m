...
- (void)testNoIDFAParameterWithOptedInUser
{
    ...
    PHPublisherIAPTrackingRequest *theTestRequest = [[PHPublisherIAPTrackingRequest requestForApp:
                ...
                PHPurchaseResolutionBuy receiptData:nil] retain];
    STAssertNotNil(theTestRequest, @"Cannot create request instance with test parameters");
    ...
    STAssertNil(theIDFA, @"IDFA should not be included in the request!");
