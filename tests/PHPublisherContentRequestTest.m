...
- (void)testNoIDFAParameter
{
    ...
    STAssertNil(theIDFA, @"No IDFA parameter is expected on when opt out status is YES!");
...
- (void)testRequestParametersCase2
{
	...
	STAssertTrue(0 == [theRequestQuery rangeOfString:@"message_id="].length, @"The parameter should"
				" not be specified for content requests which are created with placement");
    STAssertTrue((0 == [theRequestQuery rangeOfString:@"campaign_id="].length), @"The parameter "
...
- (void)testRequestParametersCase3
{
    ...
    STAssertTrue((0 < [theRequestQuery rangeOfString:[NSString stringWithFormat:
...
- (void)testNoCampaignIDParameter
{
    ...
    STAssertTrue((0 < [theRequestQuery rangeOfString:[NSString stringWithFormat:@"message_id=%@",
				kPHTestMessageID]].length), @"");
    STAssertTrue((0 == [theRequestQuery rangeOfString:@"campaign_id="].length), @"");
}
...
- (void)testNoCustomDimensions
{
    ...
    STAssertNil(theCustomDimensionsParameter, @"Custom dimensions should not be included in the "
                "content request unless they are set explicitly!");
    STAssertTrue(0 == [[theRequestURL query] rangeOfString:@"custom="].length, @"Custom dimensions "
...
- (void)testValidCustomDimensions
{
    ...
    NSString *theCustomDimensionsParameter = [theTestRequest.additionalParameters objectForKey:
                @"custom"];
    STAssertNotNil(theCustomDimensionsParameter, @"Missed custom dimensions that were set for the"
                "content request!");
    ...
    NSDictionary *theDeserializedJSON = [NSJSONSerialization JSONObjectWithData:
                ...
                error:&theError];
    STAssertNotNil(theDeserializedJSON, @"Cannot de-serialized custom dimensions: custom value - "
    ...
    STAssertEqualObjects(theDeserializedJSON, theExpectedDictionary, @"De-serialized dimensions "
    ...
    STAssertTrue(0 < [[theRequestURL query] rangeOfString:theCustomParameter].length, @"Missed "
